...
<body>
    ...
    <section class="home" id="home">
        <div class="roww">
            <div class="image">
                <img id="img" src="pic/Confused-Woman-Work-On-Laptop-Cartoon-Graphics-63402946-1-1-580x387.png" class="imgz"
                    alt="" />
            </div>
            <div class="content">
                <h3 id="landing" class="h3s">Online Courses</h3>
                <button class="btn" id="contact-btn"> <h2>Contact Us</h2></button>
            </div>
        </div>
    </section>
    <!-- end home -->
    ...
    <section class="about" id="about">
        <div class="roww">
            ...
            <div class="content">
                ...
                <button class="btn" id="contact-btn2"> <h2  >Contact Us</h2></button>
            </div>
        </div>
